<template>
  <aside class="sidebar d-flex flex-column bg-sidebar p-3">
    <div class="user-info text-center mb-4">
      <img src="https://ucarecdn.com/939b4cdc-2a7d-45f2-befc-dcda35fa088c/examplezdenekmachacek.jpg" alt="User Avatar"
    ...
    <nav class="nav flex-column flex-grow-1">
      <NuxtLink to="/" class="nav-link d-flex align-items-center" :class="{ active: isActive('/') }">
