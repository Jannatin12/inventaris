<template>
  <div class="container mt-4">
    <div class="row mb-3">
  <h1 class="col-sm-4">Disposisi Aset</h1>
  <div class="col-sm-10">
    <div class="d-flex justify-content-between align-items-center">
      <!-- Buttons Container -->
      <div class="d-flex">
        <button class="btn btn-primary d-flex align-items-center justify-content-center me-2" style="width: 180px;">
          <NuxtLink to="/form-disposisi/penerimaan-barang" 
        ...
        <button class="btn btn-primary d-flex align-items-center justify-content-center" style="width: 180px;">
          <NuxtLink to="/form-disposisi/pengiriman-barang" 
            class="btn-add text-white w-100 h-100 d-flex align-items-center justify-content-center">
